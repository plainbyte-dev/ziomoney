...
// code instead of typed in by hand. Covers every currency code present in
// data/countryCurrencyData.ts. Falls back to the code itself for anything
// not listed, so an unrecognized code still shows something rather than an
// empty label.
