          ...
          {reportLinks.map((report) => {
            ...
            return (
              <button
                ...
                className="flex w-full items-center justify-between gap-4 rounded-xl border border-border bg-white px-5 py-4 text-left transition-all hover:border-brand-green hover:shadow-card-hover"
              >
